package com.my.netty.demo.netty.snake_game;
...
public class SnakeGameServer {
    ...
    private void sendVersionData(VersionData data) {
        VersionData copy=new VersionData(data.getVersion(),data.getTime()); // 副本
        copy.setCmds(data.getCmds().clone());
        copy.setCmdDatas(data.getCmdDatas().clone());
